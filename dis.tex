...
\usepackage{pifont}
\usepackage{amsfonts}
\usepackage{CJKutf8} % piecemeal CJK
...
% Fix overfull hboxes in the TOC:
\makeatletter
...
\usepackage[backend=biber,style=authoryear-comp,natbib=true,sorting=ynt]{biblatex}
...
% HACK: Redefine appendix divider page to have a plain style:
\makeatletter
\def\@chap@pppage{%
  \clear@ppage
...
\def\archiveurl/{\url{www.escholarship.org/uc/item/32d6p0kg}}
