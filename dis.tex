...
\usepackage{blindtext} % TODO: Get rid of this...
...
\newcommand{\obvsm}[1]{\prq{obvious\_success[main]}{#1}}
\newcommand{\obvsa}[1]{\prq{obvious\_success[alt]}{#1}}
\newcommand{\obvfm}[1]{\prq{obvious\_failure[main]}{#1}}
\newcommand{\obvfa}[1]{\prq{obvious\_failure[alt]}{#1}}
