...
\usepackage{pifont}
\usepackage{amsfonts}
\usepackage[protrusion=rmonly,expansion=rmonly]{microtype}
\DeclareMicroTypeSet{rmonly}{family={rm*},}
\DeclareMicroTypeSet{sfonly}{family={sf*},}
