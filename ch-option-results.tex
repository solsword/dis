\chapter{Experimental I: Prospective Impressions}
...
The experiment presented here (and the experiment discussed in \cref{ch:outcome-results}) were set up in order to test \dunyazad/'s functionality and thereby also inform the theory of choice poetics that it is based on.
%
...
%
This chapter describes the details of the first experiment, along with much of the details of the experimental setup that are common to both experiments.
