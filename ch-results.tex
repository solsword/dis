...
%\end{tabular}
%\egroup
%  \caption{Initial between-treatment hypotheses by treatment. The ``$>$'' signs indicate more agreement relative to the alternate treatment indicated by abbreviation. ``$>$both'' indicates that that treatment is hypothesized to be more-agreed-with than both other treatments individually (two separate hypotheses).}
...
\hline
\sIqIabbr/    & \multicolumn{3}{|c|}{-} & \significant{A} & \significant{0.176} & \significant{$\times$}  & \textbf{D} & \textbf{0.009} & \textbf{66\%} \\
\hline
\sIqIIabbr/   & \textbf{A} & \textbf{0.023} & \textbf{64\%}  & \multicolumn{3}{|c|}{-} & \textbf{D} & \textbf{0.047} & \textbf{62\%} \\
\hline
\sIqIIIabbr/  & \multicolumn{3}{|c|}{-} & \textbf{A} & \textbf{0.015} & \textbf{65\%}  & \multicolumn{3}{|c}{-}\\
\hline           
\sIqIVabbr/   & \textbf{D} & \textbf{0.006} & \textbf{68\%}  & \textbf{D} & \textbf{0.005} & \textbf{68\%}  & \textbf{A} & \textbf{0.007} & \textbf{67\%} \\
\hline
\sIqVabbr/    & \significant{D} & \significant{0.069} & \significant{$\times$}  & \multicolumn{3}{|c|}{-} & \significant{A} & \significant{0.322} & \significant{$\times$}  \\
\hline
\hline
\sIqVIIabbr/  & \significant{D} & \significant{0.073} & \significant{$\times$}  & \multicolumn{3}{|c|}{-} & \textbf{A} & \textbf{0.009} & \textbf{66\%} \\
\hline
\sIqVIIIabbr/ & \multicolumn{3}{|c|}{-} & \multicolumn{3}{|c|}{-} & \textbf{A} & \textbf{0.001} & \textbf{71\%} \\
\end{tabular}
\egroup
  \caption{%
...
%
Non-significant entries are highlighted in blue.
%
...
\hline
\sIqVIIIabbr/ & \significant{dilemma$>$obvious} & \significant{0.141} & \significant{$\times$} \\
\cline{2-4}
...
%
Each row indicates a hypothesis, the corresponding $p$-value, and the effect size if the result is significant ($p < 0.05$). Significant results are shown in bold; non-significant results are in blue.
}
