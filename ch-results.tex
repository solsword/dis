...
\begin{itemize}
  ...
  \item%
    For this study, data was only filtered based on submission approval and the duplicates issue.
    %
    ...
    %
    In the end there were a total of only 13 missing responses out of the 3075 items seen by non-duplicated participants whose submissions were accepted.
    %
