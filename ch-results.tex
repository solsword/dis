...
%
As noted in \cref{sec:dunyazad-modes-of-engagement} when talking about goal analysis, \dunyazad/'s fixed goals are targeted at avatar play and power play as modes of engagement, and so it was good to see that the \pr{avatar}-related hypotheses all turned out to be correct.

\begin{figure}[!b]
\centering
{\sffamily Motives for Deciding}
\includegraphics[width=\textwidth]{{fig/motives-multi-motives}.pdf}
  \caption[TODO]{TODO}
...
\includegraphics[width=0.9\textwidth]{{fig/motives-multi-judge.good}.pdf} \\[1ex]
{ \sffamily Reasons for Negative Evaluations }
\includegraphics[width=0.9\textwidth]{{fig/motives-multi-judge.bad}.pdf}
  \caption[TODO]{TODO}
