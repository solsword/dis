...
\begin{enumerate}
  ...
  \item %
    ...
    Note that contrary to \cref{fig:choice-analysis-method}, \dunyazad/ doesn't directly incorporate information from its option analysis step into its retorspective analysis.
    TODO: HERE!
...
\begin{tabular}{p{8em} p{8em} p{8em} p{8em}}
  \prq{outcome\_feel}{}       &   \prq{option\_feel}{} values                                           &   \prq{overall\_predictability}{} values                                   &   \prq{outcome\_overall}{} values \\
...
\end{tabular}
\endgroup
\caption[Outcome feel structures]{\dunyazad/'s six outcome feel structures. If at least one of each of the given \prq{option\_feel}{,} \prq{overall\_predictability}{,} and \prq{outcome\_feel}{} lists applies to an option, the listed \prq{outcome\_feel}{} applies.}
