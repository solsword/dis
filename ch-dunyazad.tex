...
\setlength{\parskip}{0.5em}
  ...
  \cg{[representational]} Setting assignment; setting continuity and changes.

  \file{setup.lp} \\
  \cg{[representational]} Unpacking for setups; setup state creation.

  \file{skills.lp} \\
  \cg{[content]} The list of skills (but skill-action links are specified by actions). \\
  \cg{[constituent]} Outcome likelihood; skill and tool relevance.
