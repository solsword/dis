...
%
Instead, they are wrapped in \prq{st(<T>, <state>)}{} predicates, to define different states of the world for each timepoint $T$ in the story.
%
...
%
The result of the option analysis constraints is a set of \prq{at(\abr/<T>,\abr/ expectation(\abr/<option>,\abr/ <expectation>,\abr/ <goal>))}{} predicates that list the expectations for each option/goal pair (see \cref{fig:dunyazad-option-analysis-example}).
...
%
These relationships are represented using \prq{at(<T>, outcome\_perception(<option>, <perception>, <goal>))}{} predicates and have four basic \prq{perception}{} values, similar to the \prq{expectation}{} predicates generated by the option analysis step: \prq{good\_for}{,} \prq{bad\_for}{,} \prq{great\_for}{,} and \prq{awful\_for}{.}
%
