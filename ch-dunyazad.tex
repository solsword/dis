...
\begin{enumerate}
  ...
  \item %
    ...
    %
    Requiring these \prq{option\_structure}{} predicates thus allows an author (or experimenter) to generate choices that (hopefully) make a desired prospective impression on the player.
