...
\begin{enumerate}
  ...
  \item %
    ...
    Along with \prq{outcome\_overall}{} labels, this step assigns one of the following six \prq{outcome\_predictability}{} values to each option (and first to each outcome component):
    %
    \begin{enumerate}
      \item
        %
