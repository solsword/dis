...
\textbf{Unfair} & An option which seemed good but which had unexpected negative consequences. & The selected option must be expected to advance at least one high-priority player goal, while not hindering any. It must also have an unexpected and largely negative outcome. \\
\textbf{Miracle} & An option which seemed like a lost cause but which unexpectedly turned out well. & The selected option must be expected to fail at least one high-priority goal, while not advancing any. It must have an unexpected and overall positive outcome. \\
\end{tabular}
\endgroup
