...
%
\cref{fig:choice-analysis-method} gives an overview of the method described in this section.
%
TODO: HERE
Because 
...
\caption{Goal-based choice analysis for a single choice--an overview of the different steps and the information produced.}
...
\subsection{Option Combination Analysis}

\subsection{Option-Outcome Joint Analysis}
